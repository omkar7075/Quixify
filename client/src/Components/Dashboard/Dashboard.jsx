...
const Dashboard = () => {
  return (
    <div className="mt-24 sm:w-11/12 m-10 xl:ml-[340px] lg:ml-[320px] lg:w-8/12 xl:w-9/12 w-10/12  mx-auto" id="dashboard">
      {/* Main content */}
      <div className="text-center font-bold sm:text-4xl text-2xl text-shadow-md">Dashboard</div>
