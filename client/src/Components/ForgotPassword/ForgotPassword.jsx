    ...
    <div className='fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center z-50 backdrop-blur bg-black bg-opacity-50 '>
      <div className='loginSigninGradient p-5 rounded-3xl h-5/6 sm:h-[550px] xl:w-6/12 lg:w-8/12 sm:w-10/12 w-11/12 flex shadow-2xl shadow-black'>
        ...
        <div className='sm:flex sm:flex-col sm:my-auto hidden'>
          <h2 className='lg:text-3xl md:text-2xl font-bold'>Be Happy.!</h2>
          <div className='flex mt-5'>
            <p className=' border-2 border-solid border-black xl:text-xl font-bold p-3 mr-5 xl:w-36 lg:w-32 lg:text-lg md:w-32 md:max-lg:mr-3'>Create Password..</p>
            <hr className='h-0 m-auto border-[1px] border-dashed border-black xl:w-40 lg:w-36 md:w-28'/>
          </div>
        </div>
        <form className='justify-center rounded-3xl border-solid border-[1px] border-[#fff] loginSigninBackground shadow-2xl shadow-black backdrop-blur-xl flex flex-col max-w-80 p-5 h-[450px] mt-5' onSubmit={handleOnSubmit}>
          <img src={Eclipse1} className='absolute -z-10 top-32 -left-20 transform -translate-y-44 scale-75' alt="Eclipse 1" />
          <img src={Eclipse2} className='absolute -z-10 -bottom-56 -right-10 transform -translate-y-44 scale-75' alt="Eclipse 2" />
          <div className='div-2-login'>Reset Password</div>
          <div className='text-black font-medium text-sm'>Gonna create new password.!</div>
          <input
            type="password"
            name="password"
            value={password}
          ...
          <input
            ...
            required
          />
          <button type="submit" className="justify-center items-center rounded-lg mt-4 text-white whitespace-nowrap p-2 font-semibold text-base loginSigninButtonGradient">Submit</button>
